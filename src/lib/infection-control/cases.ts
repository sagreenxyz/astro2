...
export const CASES: Case[] = [
  // ── Case 1: MRSA Wound Infection ──────────────────────────────────────────
  {
    ...
    modeA: {
      precautionQuestion: 'Which level of transmission-based precautions must you initiate for Mr. Alvarez?',
      precautionOptions: [
        {
          level: 'standard',
      ...
      keyActionsInstruction: 'Select ALL actions that are correct for this situation (select every applicable action):',
      keyActions: [
        {
          id: 'mrsa-a1',
          ...
          points: 10,
          feedback: 'Correct! Gloves and gown must be donned before room entry to block direct and indirect contact transmission.',
        },
        {
          id: 'mrsa-a2',
          ...
          chainLink: 'reservoir',
          points: 10,
          feedback: 'Correct! A private room is preferred for contact precautions to reduce the risk of transmission to the roommate.',
        },
        {
          id: 'mrsa-a3',
          ...
          chainLink: 'modeOfTransmission',
          points: 10,
          feedback: 'Correct! Shared equipment is a major indirect contact transmission vector for MRSA.',
        },
        {
          id: 'mrsa-a4',
          ...
          chainLink: 'modeOfTransmission',
          points: 10,
          feedback: 'Correct! Hand hygiene after glove removal is critical — hands can become contaminated during doffing.',
        },
        {
          id: 'mrsa-a5',
        ...
        },
        {
          ...
          chainLink: 'modeOfTransmission',
          points: -5,
          feedback: 'Incorrect. N95 respirators are not required for MRSA wound infections. Gloves and gown are the appropriate PPE.',
        },
      ],
      chainLinkQuestions: [
        {
          ...
          chainLink: 'modeOfTransmission',
          options: [
            { text: 'Airborne via droplet nuclei', correct: false, points: 0, feedback: 'MRSA is not transmitted by the airborne route.' },
            {
              text: 'Direct and indirect contact (hands, surfaces, equipment)',
              correct: true,
              points: 10,
              feedback: 'Correct! MRSA spreads primarily via the contact route — HCW hands and contaminated surfaces are the main vectors.',
            },
            { text: 'Respiratory droplets from coughing', correct: false, points: 0, feedback: 'MRSA wound infection does not spread via droplets.' },
            { text: 'Vector-borne via insects', correct: false, points: 0, feedback: 'MRSA is not vector-borne.' },
          ],
        },
        {
          id: 'mrsa-clq2',
          prompt: 'Which action BEST breaks the chain of infection at the "Susceptible Host" link for the roommate?',
          ...
          options: [
            ...
            { text: 'Ask the roommate to wear gloves', correct: false, points: 0, feedback: 'Roommates do not routinely wear gloves.' },
            {
            ...
            { text: 'Use alcohol hand rub after dressing changes', correct: false, points: 5, feedback: 'Partially correct — hand hygiene helps, but the best answer is private room placement.' },
          ],
        },
      ],
      maxScore: 80,
    ...
    modeB: {
      phases: [
        { phase: 'before_entry', label: 'Before Entry', description: 'Prepare PPE and supplies outside the room' },
        { phase: 'donning', label: 'Donning PPE', description: 'Put on required PPE in correct order' },
        { phase: 'care', label: 'Patient Care', description: 'Perform wound care and assessment' },
        { phase: 'before_exit', label: 'Before Exit', description: 'Ensure patient safety and room readiness' },
        { phase: 'doffing', label: 'Doffing PPE', description: 'Remove PPE safely without self-contamination' },
      ...
      steps: [
        {
          ...
          narrative: 'You are about to enter Mr. Alvarez's room to perform a wound dressing change. What do you gather outside the room?',
          ...
          options: [
            {
              ...
              correct: true,
              points: 10,
              feedback: 'Correct! For MRSA contact precautions, gloves and gown are required. Bringing dedicated equipment prevents shared-item transmission.',
            },
            {
              id: 'mrsa-b1-b',
            ...
            },
            {
              ...
              correct: false,
              points: 0,
              feedback: 'Incorrect. Gloves alone are insufficient — a gown is also required for contact precautions.',
              contaminationEvent: 'Incomplete PPE: gown missing. Your uniform may now be colonized with MRSA.',
            },
          ],
        },
        {
          ...
          options: [
            {
              ...
              correct: true,
              points: 10,
              feedback: 'Correct! For contact precautions: perform hand hygiene first, then gown, then gloves (gloves last so they cover the gown cuffs).',
            },
            {
              id: 'mrsa-b2-b',
              ...
              correct: false,
              points: 0,
              feedback: 'Incorrect. Hand hygiene must come first. Gown before gloves ensures gloves overlap the gown cuffs.',
            ...
            },
            {
              ...
              contaminationEvent: 'Skipping hand hygiene before donning may contaminate the inside of your gloves.',
            },
          ],
        },
        {
          ...
          narrative: 'You are at the bedside and have completed the wound dressing. The old dressing is heavily soiled.',
          ...
          options: [
            {
              ...
              correct: true,
              points: 10,
              feedback: 'Correct. MRSA wound dressings go in regular (non-red-bag) waste in most facilities, keeping gloves on to avoid contamination.',
            },
            {
              id: 'mrsa-b3-b',
              ...
              correct: false,
              points: 0,
              feedback: 'Incorrect. Never remove gloves before disposal. This contaminates your hands and the hallway.',
              contaminationEvent: 'MRSA on your hands from the soiled dressing — potential for environmental contamination.',
            },
            {
              id: 'mrsa-b3-c',
              ...
              correct: false,
              points: 5,
              feedback: 'Partially acceptable in some facilities, but MRSA wound dressings typically go in regular waste, not red-bag regulated medical waste.',
            },
          ],
        },
        {
          ...
          options: [
            ...
            },
            {
              ...
              correct: false,
              points: 0,
              feedback: 'Incorrect. Gloves should be removed first because they are the most contaminated item.',
              contaminationEvent: 'Contaminated gloves touched the inside of the gown during doffing — potential self-contamination.',
            },
            {
              id: 'mrsa-b4-c',
              ...
              correct: false,
              points: 5,
              feedback: 'Partially correct, but hand hygiene should occur inside the room after removing gloves, and again after gown removal.',
            },
          ],
        },
      ],
  ...
  // ── Case 2: TB Pulmonary ───────────────────────────────────────────────────
  {
    ...
    modeA: {
      precautionQuestion: 'Which transmission-based precautions should be implemented IMMEDIATELY for Ms. Chen?',
      precautionOptions: [
        {
          level: 'standard',
          label: 'Standard Precautions only',
          ...
          points: 0,
          feedback: 'Incorrect. The clinical presentation (cavitary lesions, AFB history) strongly suggests TB. Airborne Precautions must be started immediately — do not wait for AFB culture confirmation.',
        },
        {
          level: 'contact',
          label: 'Contact Precautions',
          ...
          points: 0,
          feedback: 'Incorrect. Contact precautions address skin/surface transmission. TB is transmitted by airborne droplet nuclei — a surgical mask and contact precautions alone are insufficient.',
        },
        {
          level: 'droplet',
          label: 'Droplet Precautions',
      ...
      keyActions: [
        {
          ...
          chainLink: 'modeOfTransmission',
          points: 10,
          feedback: 'Correct! AIIR placement is the first priority to contain airborne droplet nuclei.',
        },
        {
          id: 'tb-a2',
          ...
          chainLink: 'modeOfTransmission',
          points: 10,
          feedback: 'Correct! A fit-tested N95 (or PAPR) is mandatory for entering a TB patient room. A surgical mask does not provide adequate protection.',
        },
        {
          id: 'tb-a3',
          ...
          points: 10,
          feedback: 'Correct! Masking the patient during transport reduces environmental contamination with droplet nuclei.',
        },
        {
          id: 'tb-a4',
          ...
          chainLink: 'modeOfTransmission',
          points: 10,
          feedback: 'Correct! Keeping the door closed maintains negative pressure, preventing contaminated air from escaping.',
        },
        {
          id: 'tb-a5',
        ...
        },
        {
          ...
          chainLink: 'modeOfTransmission',
          points: -5,
          feedback: 'Incorrect. A surgical mask does not filter particles <5 μm. A fit-tested N95 is required for TB.',
        },
      ],
      chainLinkQuestions: [
        {
          id: 'tb-clq1',
          prompt: 'TB droplet nuclei remain suspended in the air for extended periods. Which feature of the AIIR directly addresses this?',
          chainLink: 'modeOfTransmission',
          options: [
            {
              ...
              correct: true,
              points: 10,
              feedback: 'Correct! Negative pressure prevents contaminated air from flowing out, and high ACH dilutes and removes airborne particles.',
            },
            { text: 'Enhanced surface disinfection protocols', correct: false, points: 0, feedback: 'Surface disinfection addresses contact transmission, not airborne.' },
            { text: 'Patient isolation in a standard private room', correct: false, points: 0, feedback: 'A standard private room does not have the negative pressure or high ACH needed for TB.' },
            { text: 'Use of HEPA filters in corridor hallways', correct: false, points: 5, feedback: 'HEPA in corridors helps but is not the primary feature of an AIIR.' },
          ],
        },
        {
          id: 'tb-clq2',
          ...
          options: [
            {
              ...
              correct: true,
              points: 10,
              feedback: 'Correct! Respiratory hygiene and source masking contain respiratory secretions at the portal of exit.',
            },
            { text: 'Administering broad-spectrum antibiotics', correct: false, points: 0, feedback: 'Antibiotics address the infectious agent, not the portal of exit.' },
            { text: 'Placing the patient in an AIIR', correct: false, points: 5, feedback: 'The AIIR primarily addresses mode of transmission. Cough etiquette targets the portal of exit.' },
            { text: 'Vaccinating susceptible contacts with BCG', correct: false, points: 0, feedback: 'Vaccination acts on the susceptible host, not the portal of exit.' },
          ],
        },
      ],
      maxScore: 80,
      ...
      steps: [
        {
          ...
          narrative: 'You are outside the AIIR. The door sign says "Airborne Precautions." You need to enter to assess Ms. Chen.',
          ...
          options: [
            {
              ...
              correct: true,
              points: 15,
              feedback: 'Correct! Always verify negative pressure is functioning before entry. Then don your N95 before opening the door.',
            },
            {
              id: 'tb-b1-b',
              ...
              correct: false,
              points: 0,
              feedback: 'Incorrect. A surgical mask does not protect against airborne TB. Speed does not replace proper PPE.',
              contaminationEvent: 'Inadequate respiratory protection — potential TB exposure event.',
            },
            {
              id: 'tb-b1-c',
              ...
              correct: false,
              points: 5,
              feedback: 'Partially correct — donning N95 is right, but you should verify negative pressure before entry.',
            },
          ],
        },
        {
          ...
          options: [
            {
              ...
              correct: true,
              points: 10,
              feedback: 'Correct! A user seal check ensures the N95 is fitted correctly before entering the contaminated environment.',
            },
            {
              id: 'tb-b2-b',
              ...
              correct: false,
              points: 0,
              feedback: 'Incorrect. A user seal check should be performed every time an N95 is donned.',
              contaminationEvent: 'Poor N95 seal — potential airborne exposure to TB droplet nuclei.',
            },
            {
              id: 'tb-b2-c',
              ...
              correct: false,
              points: 0,
              feedback: 'Incorrect. Bending the nose wire helps but does not constitute a proper seal check.',
        ...
        },
        {
          ...
          narrative: 'You enter Ms. Chen\'s room. She asks if she can walk to the bathroom down the hall.',
          ...
          options: [
            {
              ...
              correct: true,
              points: 10,
              feedback: 'Correct! TB patients must remain in the AIIR. If transport is unavoidable, a surgical mask on the patient reduces contamination of the environment.',
            },
            {
              id: 'tb-b3-b',
              ...
              correct: false,
              points: 0,
              feedback: 'Incorrect. Coughing into the elbow does not contain airborne TB droplet nuclei. She must remain in the AIIR.',
              contaminationEvent: 'Unmasked TB patient in the hallway — environmental contamination risk.',
            },
            {
              id: 'tb-b3-c',
              ...
              correct: false,
              points: 8,
              feedback: 'Mostly correct — the bedside commode keeps her in the AIIR. The key additional point is that if she must leave, she must wear a surgical mask.',
            },
          ],
        },
        {
          ...
          narrative: 'Your assessment is complete. You are ready to exit. When should you remove your N95?',
          ...
          options: [
            {
              ...
              correct: true,
              points: 10,
              feedback: 'Correct! The N95 is removed outside the AIIR (or in the anteroom if available). Removing it inside the contaminated room re-exposes you to the air.',
            },
            {
              id: 'tb-b4-b',
              ...
              correct: false,
              points: 0,
              feedback: 'Incorrect. Removing the N95 inside the contaminated room exposes your airway to airborne TB organisms.',
              contaminationEvent: 'N95 removed inside AIIR — respiratory exposure to TB droplet nuclei.',
            },
            {
              id: 'tb-b4-c',
              ...
              correct: false,
              points: 5,
              feedback: 'While keeping the N95 on does not expose you, it is unnecessary and may contaminate the N95 with environmental organisms beyond the AIIR.',
            },
          ],
        },
      ],
  ...
  // ── Case 3: Influenza with AGP escalation ─────────────────────────────────
  {
    ...
    setting: 'icu',
    difficulty: 'intermediate',
    tags: ['influenza', 'droplet precautions', 'airborne precautions', 'AGP', 'escalation', 'intubation'],
    modeA: {
      precautionQuestion: 'Before the intubation procedure begins, which level of precautions is NOW required?',
      precautionOptions: [
        {
          level: 'standard',
          label: 'Standard Precautions only',
          description: 'Standard precautions for all patients.',
          points: 0,
          feedback: 'Incorrect. Mr. Thompson has confirmed influenza AND is about to undergo an AGP. Standard precautions alone are insufficient.',
        },
        {
          level: 'contact',
          label: 'Contact Precautions',
          description: 'Gloves + gown before room entry.',
          points: 0,
          feedback: 'Incorrect. Contact precautions alone do not address airborne aerosol generation during intubation.',
        },
        {
          level: 'droplet',
          label: 'Droplet Precautions',
          ...
          points: 5,
          feedback: 'Partially correct for routine influenza care, but NOT for the intubation procedure. AGPs generate fine aerosols requiring airborne-level protection (N95).',
        },
        {
          level: 'airborne',
          ...
          points: 20,
          feedback: 'Correct! Endotracheal intubation is an aerosol-generating procedure (AGP). Influenza precautions must be escalated to airborne (N95 or PAPR) for this procedure.',
        },
      ],
      ...
      keyActions: [
        {
          ...
          chainLink: 'modeOfTransmission',
          points: 10,
          feedback: 'Correct! Intubation is a high-risk AGP. N95 or PAPR is required to protect against aerosol transmission.',
        },
        {
          id: 'flu-a2',
          ...
          chainLink: 'modeOfTransmission',
          points: 10,
          feedback: 'Correct! Eye protection is essential during intubation to protect the conjunctiva from respiratory secretions and aerosols.',
        },
        {
          id: 'flu-a3',
          ...
          chainLink: 'susceptibleHost',
          points: 10,
          feedback: 'Correct! Minimizing personnel in the room during AGPs reduces the number of people exposed to infectious aerosols.',
        },
        {
          id: 'flu-a4',
          ...
          chainLink: 'modeOfTransmission',
          points: -10,
          feedback: 'Incorrect. During AGPs, influenza aerosols behave like airborne particles. A surgical mask is inadequate — escalate to N95 or PAPR.',
        },
        {
          id: 'flu-a5',
          ...
          chainLink: 'infectiousAgent',
          points: 5,
          feedback: 'Correct (though secondary to PPE). Antivirals reduce viral shedding and infectiousness — part of a comprehensive prevention strategy.',
        },
      ],
      chainLinkQuestions: [
        {
          id: 'flu-clq1',
          prompt: 'What specifically makes endotracheal intubation an "aerosol-generating procedure" that changes the PPE requirements?',
          chainLink: 'modeOfTransmission',
          options: [
            {
              ...
              correct: true,
              points: 10,
              feedback: 'Correct! AGPs disrupt the airway and create fine aerosol particles that travel farther and remain suspended longer than respiratory droplets.',
            },
            { text: 'Intubation involves direct contact with blood, requiring higher precautions', correct: false, points: 0, feedback: 'While blood contact is possible, the primary concern is aerosol generation.' },
            { text: 'ICU patients always require airborne precautions', correct: false, points: 0, feedback: 'ICU admission alone does not mandate airborne precautions.' },
            { text: 'The ventilator itself spreads the virus through its exhaust', correct: false, points: 0, feedback: 'Modern closed ventilator circuits with HEPA filters contain exhaled gas safely.' },
          ],
        },
        {
          id: 'flu-clq2',
          prompt: 'After the intubation is complete and Mr. Thompson is on the ventilator, you return to routine care. Which precautions apply?',
          chainLink: 'modeOfTransmission',
          options: [
            {
              ...
              correct: true,
              points: 10,
              feedback: 'Correct! Escalation to airborne is only required DURING AGPs. Between procedures, routine influenza care requires droplet precautions (surgical mask).',
            },
            { text: 'Continue airborne precautions at all times for safety', correct: false, points: 0, feedback: 'While more cautious, this is not evidence-based for routine care and wastes scarce N95 resources.' },
            { text: 'Standard precautions only — the patient is now intubated', correct: false, points: 0, feedback: 'Being intubated does not eliminate the need for droplet precautions in an influenza patient.' },
            { text: 'No precautions needed — the patient is sedated and cannot cough', correct: false, points: 0, feedback: 'Sedation does not eliminate viral shedding. Droplet precautions remain necessary.' },
          ],
        },
      ],
      maxScore: 75,
    ...
    modeB: {
      phases: [
        { phase: 'before_entry', label: 'Pre-Procedure', description: 'Set up outside the ICU room' },
      ...
      steps: [
        {
          ...
          narrative: 'The intensivist announces intubation is needed NOW. You must gather PPE rapidly.',
          prompt: 'Which PPE set is correct for assisting with intubation in this influenza patient?',
          options: [
            {
              id: 'flu-b1-a',
              ...
              correct: true,
              points: 10,
              feedback: 'Correct! All four elements are required for an AGP on an influenza patient: N95, eye protection, gloves, and gown.',
            },
            {
              id: 'flu-b1-b',
              ...
              correct: false,
              points: 0,
              feedback: 'Incorrect. Surgical mask is inadequate for intubation. An N95 is required for this AGP.',
              contaminationEvent: 'Inadequate respiratory protection during an AGP — potential influenza aerosol exposure.',
            },
            {
              id: 'flu-b1-c',
              ...
              correct: false,
              points: 0,
              feedback: 'Incorrect. Gloves alone without gown leaves clothing exposed. Eye protection is also missing.',
              contaminationEvent: 'Missing gown and eye protection — body fluids and aerosol splash risk.',
            },
          ],
        },
        {
          ...
          narrative: 'The intubation is in progress. A colleague knocks and asks to enter to check on another patient\'s IV pump.',
          ...
          options: [
            {
              ...
              correct: true,
              points: 10,
              feedback: 'Correct! During AGPs, room entry should be restricted to essential personnel only.',
            },
            {
              id: 'flu-b2-b',
              ...
              correct: false,
              points: 0,
              feedback: 'Incorrect. A surgical mask provides inadequate protection during an AGP. They should not enter without an N95.',
              contaminationEvent: 'Additional personnel exposed to influenza aerosols with inadequate PPE.',
            },
            {
              id: 'flu-b2-c',
              ...
              correct: false,
              points: 5,
              feedback: 'If entry is truly essential, ensuring N95 use is correct. But non-essential personnel should not enter during an AGP regardless.',
            },
          ],
        },
        {
          ...
          narrative: 'The intubation is complete. The patient is on the ventilator. You are ready to step out.',
          ...
          options: [
            {
              ...
              correct: true,
              points: 15,
              feedback: 'Correct! N95 is removed last, outside the room, to avoid self-contamination from a potentially soiled outer surface.',
            },
            {
              id: 'flu-b3-b',
              ...
              correct: false,
              points: 0,
              feedback: 'Incorrect. The N95 should be removed last (outside the room). Removing it first while still in the contaminated area defeats its purpose.',
              contaminationEvent: 'Early N95 removal in contaminated environment — respiratory exposure risk.',
            },
            {
              id: 'flu-b3-c',
              ...
              correct: false,
              points: 5,
              feedback: 'Gloves before gown is correct, but the N95 should be removed OUTSIDE or in the anteroom, not inside the patient room.',
            },
          ],
        },
      ],
      ...
      precautionOptions: [
        {
          ...
          description: 'Standard precautions for all patients.',
          points: 0,
          feedback: 'Incorrect. CDI requires Contact Precautions to prevent fecal-oral transmission via spores.',
        },
        {
          level: 'contact',
          label: 'Contact Precautions',
          ...
          points: 20,
          feedback: 'Correct! CDI is transmitted via fecal-oral route. Contact Precautions with gloves and gown are required.',
        },
        {
          level: 'droplet',
          label: 'Droplet Precautions',
          description: 'Surgical mask within 3 feet.',
          points: 0,
          feedback: 'Incorrect. C. diff is not transmitted by respiratory droplets — it spreads via fecal-oral contact with spores.',
        },
        {
          level: 'airborne',
          label: 'Airborne Precautions',
      ...
      keyActions: [
        {
          ...
          chainLink: 'modeOfTransmission',
          points: 15,
          feedback: 'CRITICAL! Alcohol-based hand rub does NOT kill C. diff spores. Soap and water physically removes spores from hands. This is the most important C. diff hand hygiene rule.',
        },
        {
          id: 'cdiff-a2',
        ...
        },
        {
          ...
          chainLink: 'reservoir',
          points: 10,
          feedback: 'Correct! C. diff spores resist most standard hospital disinfectants. Bleach (≥1,000 ppm hypochlorite) is required to kill spores.',
        },
        {
          id: 'cdiff-a4',
          ...
          chainLink: 'reservoir',
          points: 10,
          feedback: 'Correct! A private room prevents transmission to roommates who may be especially vulnerable after antibiotic exposure.',
        },
        {
          id: 'cdiff-a5',
          ...
          chainLink: 'modeOfTransmission',
          points: -15,
          feedback: 'INCORRECT and dangerous! Alcohol does not kill C. diff spores. You MUST use soap and water for C. diff, even if you have to walk to a farther sink.',
        },
      ],
      chainLinkQuestions: [
        {
          id: 'cdiff-clq1',
          prompt: 'Why does C. diff hand hygiene require soap and water instead of alcohol-based hand rub?',
          chainLink: 'modeOfTransmission',
          options: [
            {
              ...
              correct: true,
              points: 10,
              feedback: 'Correct! Alcohol hand rub kills vegetative bacteria but cannot destroy C. diff spores. Soap and water physically lifts and rinses spores away.',
            },
            { text: 'Alcohol is not a registered disinfectant', correct: false, points: 0, feedback: 'Alcohol IS an effective disinfectant for many organisms, but not C. diff spores.' },
            { text: 'Soap and water is always more effective than ABHR for all organisms', correct: false, points: 0, feedback: 'For most organisms, ABHR is equally or more effective. C. diff spores are the exception.' },
            { text: 'C. diff is transmitted by respiratory droplets that soap removes from hands', correct: false, points: 0, feedback: 'C. diff is not respiratory — it is transmitted by fecal-oral spore contact.' },
          ],
        },
        {
          id: 'cdiff-clq2',
          ...
          options: [
            {
              ...
              correct: true,
              points: 10,
              feedback: 'Correct! Antibiotics disrupt the gut microbiome, allowing C. diff to proliferate and produce toxins. Antimicrobial stewardship is the key prevention strategy.',
            },
            { text: 'Her age (78 years)', correct: false, points: 5, feedback: 'Age is a risk factor but not the PRIMARY driver here — antibiotic exposure is the most direct cause.' },
            { text: 'Drinking contaminated water', correct: false, points: 0, feedback: 'CDI in healthcare settings is primarily nosocomial, not from contaminated water.' },
            { text: 'Contact with a sick visitor', correct: false, points: 0, feedback: 'While possible, the most likely source is the hospital environment and her own antibiotic-altered flora.' },
          ],
        },
      ],
      maxScore: 85,
      ...
      steps: [
        {
          ...
          narrative: 'You need to enter Mrs. Park\'s room. There is an ABHR dispenser right outside the door and a sink with soap 10 feet down the hall.',
          ...
          options: [
            {
              ...
              correct: true,
              points: 10,
              feedback: 'Correct! Even though it requires extra steps, soap and water is mandatory for C. diff. Alcohol hand rub will not remove spores.',
            },
            {
              id: 'cdiff-b1-b',
              ...
              correct: false,
              points: 0,
              feedback: 'Incorrect. ABHR does not kill or remove C. diff spores. Soap and water is required before and after caring for CDI patients.',
              contaminationEvent: 'Spores on hands not removed — potential transmission to next patient.',
            },
            {
              id: 'cdiff-b1-c',
              ...
              correct: false,
              points: 0,
              feedback: 'Incorrect. Hand hygiene is required before donning gloves. Gloves can have microscopic defects and are not a substitute for hand hygiene.',
        ...
        },
        {
          ...
          narrative: 'Environmental services asks you which cleaning product to use for Mrs. Park\'s room.',
          ...
          options: [
            {
              ...
              correct: true,
              points: 10,
              feedback: 'Correct! Bleach at ≥1,000 ppm is the CDC-recommended sporicidal agent for C. diff environmental decontamination.',
            },
            {
              id: 'cdiff-b2-b',
              ...
              correct: false,
              points: 0,
              feedback: 'Incorrect. Quaternary ammonium compounds do not kill C. diff spores. They are NOT effective for CDI environmental cleaning.',
              contaminationEvent: 'Spores persist on surfaces — risk of transmission to future room occupants.',
            },
            {
              id: 'cdiff-b2-c',
          ...
          options: [
            {
              ...
              correct: true,
              points: 15,
              feedback: 'Correct! After glove and gown removal, wash hands with soap and water. This is mandatory for CDI — alcohol hand rub is insufficient.',
            },
            {
              id: 'cdiff-b3-b',
              ...
              correct: false,
              points: 0,
              feedback: 'Incorrect. C. diff spores must be physically removed with soap and water, not killed with alcohol.',
              contaminationEvent: 'Spores remain on hands after ABHR use — risk of environmental spread.',
            },
            {
              id: 'cdiff-b3-c',
              ...
              correct: false,
              points: 0,
              feedback: 'Incorrect. Hands can become contaminated during glove removal. Hand hygiene after doffing is always required.',
  ...
  // ── Case 5: COVID-19 ──────────────────────────────────────────────────────
  {
    ...
    modeA: {
      precautionQuestion: 'For routine assessment of Ms. Rivera (before HFNC), which precautions are required?',
      precautionOptions: [
        {
          level: 'standard',
          label: 'Standard Precautions only',
        ...
        },
        {
          ...
          points: 0,
          feedback: 'Incorrect. COVID-19 is primarily a respiratory pathogen. Respiratory precautions (surgical mask) are essential.',
        },
        {
          level: 'droplet',
          ...
          points: 20,
          feedback: 'Correct! Per CDC guidance, droplet precautions (surgical mask + eye protection + gloves + gown) are required for routine COVID-19 patient care.',
        },
        {
          level: 'airborne',
          ...
          description: 'N95 in a negative-pressure room.',
          points: 10,
          feedback: 'Partially correct. Many institutions use N95 for all COVID care, but the CDC minimum standard for routine care is droplet precautions. N95 is required during AGPs (like HFNC at high flows).',
        },
      ],
      ...
      keyActions: [
        {
          ...
          chainLink: 'modeOfTransmission',
          points: 15,
          feedback: 'Correct! HFNC at high flow rates is considered an AGP that may generate aerosols. Upgrade to N95 per institutional and CDC guidance.',
        },
        {
          id: 'covid-a2',
          ...
          points: 10,
          feedback: 'Correct! Eye protection is required for all COVID-19 patient care to protect conjunctival exposure.',
        },
        {
          id: 'covid-a3',
          ...
          chainLink: 'modeOfTransmission',
          points: 10,
          feedback: 'Correct! Keeping the door closed maintains negative pressure, preventing contaminated air from escaping into the corridor.',
        },
        {
          id: 'covid-a4',
          ...
          chainLink: 'modeOfTransmission',
          points: -10,
          feedback: 'Incorrect. HFNC at ≥30–40 L/min may generate aerosols. Upgrade to N95 for HFNC initiation and high-flow care.',
        },
        {
          id: 'covid-a5',
          ...
          chainLink: 'portalOfExit',
          points: 5,
          feedback: 'Correct (where feasible). Source masking helps contain respiratory particles at the portal of exit.',
        },
      ],
      chainLinkQuestions: [
        {
          id: 'covid-clq1',
          prompt: 'Which COVID-19 prevention measure operates at the "Susceptible Host" chain link?',
          chainLink: 'susceptibleHost',
          options: [
            {
              ...
              correct: true,
              points: 10,
              feedback: 'Correct! Vaccination reduces susceptibility by priming the immune system, acting directly on the "Susceptible Host" link.',
            },
            { text: 'N95 respirator use', correct: false, points: 0, feedback: 'N95 blocks the mode of transmission, not the susceptible host.' },
            { text: 'Negative-pressure room', correct: false, points: 0, feedback: 'The AIIR controls the mode of transmission, not host susceptibility.' },
            { text: 'Antiviral therapy (nirmatrelvir-ritonavir)', correct: false, points: 5, feedback: 'Antivirals reduce the infectious agent (viral load), not host susceptibility.' },
          ],
        },
        {
          id: 'covid-clq2',
          prompt: 'Ms. Rivera\'s COVID test was positive 2 days BEFORE she developed symptoms. Which feature of COVID-19 does this illustrate?',
          chainLink: 'reservoir',
          options: [
            {
              ...
              correct: true,
              points: 10,
              feedback: 'Correct! SARS-CoV-2 viral load peaks around symptom onset, but infectious spread can occur 1–3 days before symptoms — a key driver of community spread.',
            },
            { text: 'COVID-19 tests have a high false-positive rate', correct: false, points: 0, feedback: 'Molecular PCR tests have very high specificity. This is not a false positive.' },
            { text: 'She acquired COVID-19 in the hospital', correct: false, points: 0, feedback: 'No evidence of healthcare acquisition is mentioned.' },
            { text: 'COVID-19 has a very long incubation period', correct: false, points: 0, feedback: 'The incubation is 2–14 days (median ~5 days), not unusually long.' },
          ],
        },
      ],
      maxScore: 80,
    ...
    modeB: {
      phases: [
        ...
        { phase: 'doffing', label: 'Doffing', description: 'Remove PPE without self-contamination' },
          ...
          options: [
            {
              ...
              correct: true,
              points: 10,
              feedback: 'Correct! HFNC is an AGP. All four PPE elements are required: N95, eye protection, gloves, and gown.',
            },
            {
              id: 'covid-b1-b',
              ...
              correct: false,
              points: 0,
              feedback: 'Incorrect. A surgical mask is insufficient for an AGP. An N95 is required for HFNC initiation.',
              contaminationEvent: 'Inadequate filtration during HFNC AGP — potential aerosol exposure.',
            },
            {
              id: 'covid-b1-c',
              ...
              correct: false,
              points: 0,
              feedback: 'Incorrect. A gown is required to protect clothing and skin from respiratory secretions.',
              contaminationEvent: 'Clothing exposed to respiratory secretions — potential secondary transmission.',
            },
          ],
        },
        {
          ...
          narrative: 'You have completed the HFNC setup. The face shield is visibly splashed with secretions.',
          ...
          options: [
            {
              ...
              correct: true,
              points: 10,
              feedback: 'Correct! Face shields are removed by the clean headband/side pieces. Touching the contaminated front causes self-contamination. Clean/disinfect for reuse or discard.',
            },
            {
              id: 'covid-b2-b',
              ...
              correct: false,
              points: 0,
              feedback: 'Incorrect. Wiping the contaminated front with a gloved hand then touching the headband transfers contamination.',
              contaminationEvent: 'Contaminated glove-to-headband contact — potential face exposure during removal.',
            },
            {
              id: 'covid-b2-c',
              ...
              correct: false,
              points: 5,
              feedback: 'Partially correct in some protocols, but the standard sequence removes gloves first, then gown, then eye protection, then N95 last (outside). Check your facility\'s protocol.',
            },
          ],
        },
        {
          ...
          phase: 'doffing',
          title: 'N95 Removal',
          narrative: 'You have removed gloves, gown, and eye protection. You are now outside Ms. Rivera\'s room.',
          ...
          options: [
            {
              ...
              correct: true,
              points: 15,
              feedback: 'Correct! The outer surface of the N95 is contaminated. Grasp only the straps/headbands. Dispose of or store per institutional protocol. Perform hand hygiene immediately.',
            },
            {
              id: 'covid-b3-b',
              ...
              correct: false,
              points: 0,
              feedback: 'Incorrect. Touching the contaminated outer surface of the N95 contaminates your hands.',
              contaminationEvent: 'Hands contaminated by touching N95 outer surface — risk of face/mucous membrane exposure.',
            },
            {
              id: 'covid-b3-c',
              ...
              correct: false,
              points: 0,
              feedback: 'Incorrect. Wearing a potentially contaminated N95 through the unit spreads contamination to clean areas.',
